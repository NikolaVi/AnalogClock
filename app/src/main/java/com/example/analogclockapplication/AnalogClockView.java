package com.example.analogclockapplication;
...
public class AnalogClockView  extends View {
    ...
    private void drawHand(Canvas canvas, float v, boolean b) {
        double angle = Math.PI * v / 30 - Math.PI / 2;
        int handRadius = b ? radius - handTruncation - hourHandTruncation : radius - handTruncation;
